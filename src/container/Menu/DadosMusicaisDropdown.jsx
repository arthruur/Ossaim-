...
const DadosMusicaisDropdown = () => {
  ...
  const renderDadosMusicaisContent = () => {
    switch (selectedCenso) {
      ...
      case 'revisores-qualitativos-fernandes':
        return (
          <iframe
            title="Dados Qualitativos - Fernandes"
            src="https://app.powerbi.com/view?r=eyJrIjoiMWMxMDVjNmMtMGVjMi00ZTdhLTg5N2ItOGQ1NjhiZTBlNGJiIiwidCI6IjY5NmQxOWU0LWZjNzUtNGU4NS05MzdlLWU1M2UwNmFlNWYzYiJ9&pageName=91658861cf1e7353cdbc"
            style={{ width: '100%', height: '600px' }}
          ></iframe>
        );
      default:
  ...
  return (
    <div>
      ...
      >
        ...
        <option value="revisores-qualitativos-fernandes">Dados Qualitativos - Fernandes</option>
      </select>
