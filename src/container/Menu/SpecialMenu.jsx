  ...
  return (
    <div className='app__specialMenu flex__center section__padding' id='menu'>
      <div className='app__specialMenu-title'>
        <h1 className='headtext__cormorant'>Estado Colaborativo da Arte da Pesquisa em EMPDIC.
        </h1>
      </div>
      
      {/* Navbar para navegação entre as guias */}
      <ul className='app__navbar-links'>
        <li onClick={() => setActiveTab('dados-publicos')} className={activeTab === 'dados-publicos' ? 'active' : ''}> Dados Estatísticos Públicos</li>
        <li onClick={() => setActiveTab('dados-estatisticos')} className={activeTab === 'dados-estatisticos' ? 'active' : ''}> Dados Estatísticos Musicais</li>
        ...
        <li onClick={() => setActiveTab('observatorio-ossaim')} className={activeTab === 'observatorio-ossaim' ? 'active' : ''}>Observatório</li>
        ...
        <li onClick={() => setActiveTab('pesquisa')} className={activeTab === 'pesquisa' ? 'active' : ''}>Projeto de Pesquisa</li>
      </ul>
