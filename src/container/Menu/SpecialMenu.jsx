...
import FerramentasOssaim from './Ferramentas';
...
const SpecialMenu = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'ferramentas-ossaim':
        return <div> <FerramentasOssaim /> </div>;
      case 'estado-da-arte':
      ...
      case 'linha-do-tempo':
        return (
          <div>
            ...
            <iframe
              src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=17CWx1bNu54RvIKtNhUBPsfOmclWAi741k4_pff5kklI&font=Default&lang=en&initial_zoom=2&height=600"
              width="100%"
              height="600"
              frameBorder="0"
              allowFullScreen
  ...
  return (
    <div className='app__specialMenu flex__center section__padding' id='menu'>
      ...
      <ul className='app__navbar-links'>
        <li onClick={() => setActiveTab('di')} className={activeTab === 'di' ? 'active' : ''}> Sobre DI</li>
        <li onClick={() => setActiveTab('dados-publicos')} className={activeTab === 'dados-publicos' ? 'active' : ''}> Dados Públicos</li>
        <li onClick={() => setActiveTab('ferramentas-ossaim')} className={activeTab === 'ferramentas-ossaim' ? 'active' : ''}> Ferramentas Ossaim</li>
        ...
        <li onClick={() => setActiveTab('cartografias')} className={activeTab === 'cartografias' ? 'active' : ''}>Cartografias de Pereira</li>
